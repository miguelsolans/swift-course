...
// Default Implementation by using extension
/*
 * Whenever a class or struct adapts this extension, automatically has access to the fly method
 */
extension CanFly {
    func fly() {
        print("The takes off into the air")
    }
}
